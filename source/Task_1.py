...
class SklearnPipelineFlow(FlowSpec):
    ...
    def train_model(self):
        ...
        # Log tên mô hình tổng hợp (nếu cần)
        mlflow.log_param("model", "RandomForest and KNN")

        # Log thông tin cho RandomForest
        mlflow.log_param("model_type_rf", "RandomForest")
        ...
        # Log thông tin cho KNN
        mlflow.log_param("model_type_knn", "KNN")
